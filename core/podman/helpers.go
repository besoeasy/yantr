...
// ContainerList wraps the Podman API to list containers.
...
// ContainerInspect wraps the Podman API to inspect a container.
...
// ContainerStats wraps the Podman API to get container stats.
...
// ContainerLogs wraps the Podman API to get container logs.
...
// ContainerStop wraps the Podman API to stop a container.
...
// ContainerRemove wraps the Podman API to remove a container.
...
// ContainerStart wraps the Podman API to start a container.
...
// ContainerRestart wraps the Podman API to restart a container.
...
// ContainerCreate wraps the Podman API to create a container.
...
// NetworkList wraps the Podman API to list networks.
...
// ImageList wraps the Podman API to list images.
...
// ImagesPrune wraps the Podman API to prune images.
...
// Info wraps the Podman API to get system info.
func Info(ctx context.Context) (system.Info, error) {
	return Client.Info(ctx)
}

// VolumesPrune wraps the Podman API to prune volumes.
...
// VolumeList wraps the Podman API to list volumes.
