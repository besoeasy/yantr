...
<template>
  <div class="relative group h-full flex flex-col rounded-[24px] overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(6,182,212,0.3)] text-left w-full min-h-[320px] cursor-pointer border border-gray-200/60 dark:border-white/5 bg-gradient-to-br from-white to-slate-50 dark:from-[#111827] dark:to-[#09090b]" @click="router.push('/apps/portainer')">
    
    <!-- Animated Gradient Glow -->
    <div class="absolute -top-[50%] -left-[50%] w-[200%] h-[200%] bg-[radial-gradient(circle_at_50%_50%,_rgba(6,182,212,0.12)_0%,_transparent_40%)] opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none group-hover:animate-[spin_20s_linear_infinite]"></div>

    <!-- Massive Watermark Icon -->
    <LayoutGrid class="absolute -bottom-8 -right-8 w-64 h-64 text-cyan-500-[0.03] dark:text-cyan-400/[0.03] rotate-[-20deg] group-hover:rotate-0 group-hover:scale-110 transition-all duration-700 ease-out pointer-events-none" />
    ...
    <div class="relative z-10 p-7 flex flex-col h-full gap-4">
      ...
      <div class="flex items-start justify-between">
        <div class="flex items-center gap-4">
          <!-- Gorgeous Icon Block -->
          <div class="relative w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 bg-gradient-to-br from-cyan-400 to-blue-600 shadow-xl shadow-cyan-500/40 group-hover:shadow-cyan-500/60 transition-all duration-500 group-hover:scale-105">
          ...
          <div>
            ...
            <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 dark:text-zinc-500 mt-2">Docker Environment</p>
          </div>
        </div>
        
        <!-- Premium Status Pill -->
        <div class="flex items-center gap-2 px-3 py-1.5 rounded-full border backdrop-blur-md shadow-sm transition-colors duration-500" :class="isRunning ? 'bg-cyan-50/90 border-cyan-200 dark:bg-cyan-900/30 dark:border-cyan-500/30' : 'bg-gray-100 border-gray-200 dark:bg-zinc-800/80 dark:border-zinc-700'">
      ...
      <div class="mt-auto pt-6 flex flex-col relative z-10">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="p-4 rounded-[16px] bg-white/70 dark:bg-black/40 backdrop-blur-xl border border-white/60 dark:border-white/5 flex flex-col gap-1.5 group-hover:bg-white/90 dark:group-hover:bg-white/[0.03] transition-all duration-300 shadow-sm">
            ...
            <div class="text-sm font-black text-gray-900 dark:text-white tabular-nums tracking-tight">
               {{ isRunning ? 'Running' : 'Stopped' }}
            </div>
          </div>
          
          <div class="p-4 rounded-[16px] bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-950/40 dark:to-blue-950/40 backdrop-blur-xl border border-cyan-100 dark:border-cyan-900/50 flex flex-col justify-center items-center group-hover:shadow-md transition-all duration-300 group/btn relative overflow-hidden">
            ...
            <div class="text-[11px] font-black text-cyan-600 dark:text-cyan-400 uppercase tracking-widest flex items-center gap-1.5 relative z-10 group-hover/btn:text-cyan-700 dark:group-hover/btn:text-cyan-300 transition-colors">
